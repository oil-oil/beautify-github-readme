...
- **[shadybad](https://github.com/shadybad)** — turns a GitHub profile README into a project-native agent-loop hero and matching section headers, with an animated GIF rendered from the SVG source.
